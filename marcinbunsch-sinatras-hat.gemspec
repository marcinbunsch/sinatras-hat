...
Gem::Specification.new do |s|
  s.name = %q{marcinbunsch-sinatras-hat}
  s.version = "0.1.2"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Pat Nakajima", "Brad Phelan", "Marcin Bunsch"]
  s.date = %q{2010-06-19}
  ...
  s.files = [
    ".gitignore",
     ...
     "marcinbunsch-sinatras-hat.gemspec",
  ...
  s.homepage = %q{http://github.com/marcinbunsch/sinatras-hat}
